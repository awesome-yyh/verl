...
# merge_train_path=/data/app/yangyahe/base_datasets/gsm8k/train.parquet
# merge_test_path=/data/app/yangyahe/base_datasets/gsm8k/test.parquet

merge_train_path="data/anli_ft_train_system.parquet"  # 包含正确句的比例: 394621 / 787030 = 0.50, 正确到正确的比例: 248742 / 787030 = 0.32
merge_test_path="data/anli_ft_test_system.parquet"  # 包含正确句的比例: 502 / 968 = 0.52, 正确到正确的比例: 322 / 968 = 0.33
...
RAY_RESOURCES='{"GPU": 4}' \
RAY_RAYLET_GPU_DEVICES="4,5,6,7" \
