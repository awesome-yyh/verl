...
python scripts/txt2parquet_merge.py --input ../term-corrector/data/merge/拦截案例_f97589df-e3b8-47e2-aba4-62197fa5d667.csv_test_doubao_explanation-merge.jsonl --output data/拦截案例_f97589df-e3b8-47e2-aba4-62197fa5d667.csv_test_doubao_explanation-merge_train.parquet --data_source anli_ft --split train

python scripts/txt2parquet_merge.py --input ../term-corrector/data/merge/误拦截all.csv_015f309d-b27d-4f16-9381-c3a737d403d8.txt_test_doubao_explanation-merge.jsonl --output data/误拦截all.csv_015f309d-b27d-4f16-9381-c3a737d403d8.txt_test_doubao_explanation-merge_train.parquet --data_source anli_ft --split train
